        ...
        <div class="col-6">
          ...
          <div class="item">
            ...
            <div class="item">
              ...
              <input id="state" type="text"   name="cust_state" value="<?=$tmp[0]['cust_state']?>">
            </div>
            <div class="item">
              <label for="zip">Zip/Postal Code<span>*</span></label>
              <input id="zip" type="text" name="cust_zip" value="<?=$tmp[0]['cust_zipcode']?>">
            </div>
        </div><!--col-6-->  
      </div>
          ...
          <div class="row">
              ...
              <div class="col-4">
                <div class="item">
                  ...
                  <input type="text" name="pkg_val"value="<?=$tmp[0]['package_value']?>"/>
                </div> 
              </div><!--col-4-->      
            </div><!--row-->                  
          </div><!--item-col-12-->        
          <div class="item package_div">
            <?php for($i = 0; $i < $tmp[0]['num_of_package']; $i++) {?>
              <div class="item">
                <label style="font-weight: bold">Pkg #<?=($i+1)?> Description</label>
                <textarea class="form-control" name="pkg_desc<?=($i+1)?>" id="exampleFormControlTextarea1" rows="3" required><?=$tmp[$i]['package_desc']?></textarea>
                <label>Weight (lbs)</label>
                <input id="pkg_wt<?=($i+1)?>" type="text" id="pkg_wt<?=($i+1)?>" name="pkg_wt<?=($i+1)?>" class="pkg_weight" required/>
                <hr>
              </div><!--item-->  
            <?php } ?>
            <!--<div class="item">
