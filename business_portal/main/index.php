	...
	<?php if ((strcmp(strtolower($position), 'admin') == 0) || (strcmp(strtolower($position), 'owner') == 0)) { ?>
		<nav class="navbar-primary sticky">
			...
			<ul class="navbar-primary-menu">
				...
				<li><a href="sales_reports/salereport.php" class="nav-link text-white"><i class="icon-bar-chart icon-2x"></i> Sales Report</a></li>		
			</ul>
		</nav><!--/.navbar-primary-->
		<div class="main-content">
			...
			<div id="maindashboard">             
				...
				<a href="sales_reports/salereport.php"><i class="icon-bar-chart icon-2x"></i><br> Sales Report</a>
