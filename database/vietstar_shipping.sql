...
--
-- Host: localhost:8889
-- Generation Time: Mar 02, 2022 at 09:54 PM
...
(58, 'SKU001', 'Vitamin', ' Vitamin C ', 35, 'Multi-Vitamin', 7, 'Middle shelf - 5B'),
(59, 'SKU002', 'Dairy', ' Ensure milk ', 35, 'YumYum', 6, 'Left shelf - 4A'),
...
(2, 6, 3, '2022-02-16', 10, 5, 65),
(3, 6, 3, '2022-02-16', 20, 10, 65),
(7, 5, 1, '2022-02-03', 10, 20, 58);
...
(386, 'RS-32330', 1, 35, 0, 58, NULL, NULL),
(387, 'RS-3039900', 1, 35, 0, 59, NULL, NULL),
(388, 'RS-7', 10, 350, 0, 59, 150, NULL),
(389, 'RS-0023322', 1, 35, 0, 59, 150, NULL);
...
(7, 'Mahesh', '1022', '7176893783', '532839238', '');
...
--
ALTER TABLE `sales_order`
  MODIFY `sales_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=390;
